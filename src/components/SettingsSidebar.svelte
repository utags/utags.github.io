            ...
            <div class="flex items-center justify-between px-1 py-0.5">
              ...
              <div
                ...
                <label class="relative flex-1">
                  ...
                  <span
                    class="block cursor-pointer rounded-md px-4 py-1.5 text-center text-sm transition-colors peer-checked:bg-white peer-checked:text-gray-800 peer-focus:ring-2 peer-focus:ring-blue-500 peer-focus:ring-offset-1 dark:peer-checked:bg-gray-600 dark:peer-checked:text-gray-100 dark:peer-focus:ring-blue-400">
                    左
                  </span>
                </label>
                <label class="relative flex-1">
